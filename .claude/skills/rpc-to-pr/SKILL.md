...
- 個人情報（id, name, email 等）が含まれる場合はマスク方針を確認
...
- **個人情報マスク**: レスポンスに id, name, email 等が含まれる場合、PR の公開範囲を踏まえてユーザーに「このまま貼るか / マスクするか」確認する。一部だけマスクすると半端なので、個人情報フィールドは一括でダミー化する方が安全
